...
- [ ] 我们发现同学们提交的任务跑出来的结果，大部分都是0分，原因可能是航线超高了。一开始为了降低大家调试的难度，我们给大家提供的sdk航线高度限制是150米，Python的demo航线高度是145米，但是线上的飞机航线限高120米，所以大家直接提交demo，跑出来的分数为0分。同学们要自己规划，降低航线高度，线上的卸货点和SDK中是不一致的，需要大家在代码中动态规划航线。降低航线高度后，注意避开地图障碍物。

- [ ] 如果第一个点的类型是takeoff，飞机就会垂直起飞离地3m（takeoff和land类型的时候，设置的点是没有用的）

- [ ] 在飞机上货和换电的时候，不要操作小车和飞机
